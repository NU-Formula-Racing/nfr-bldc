...
#define HW_NAME					"NFR_FRONT_INVERTER"
...
#endif
#ifndef VIN_R1
#define VIN_R1					187.5 // 3000000/10000 * 10/16
#endif
#ifndef VIN_R2
#define VIN_R2					1 // 10000/10000
#endif
// Defined in V/V
...
#define NTC_RES(adc_val)		(5.0*(3.3-v_adc(adc_val))) / (((3.3 * 5.0) / 1000.0) + 0.00002 - ((5.0/1000.0)*(3.3-v_adc(adc_val))))
