...
#define NTC_DIVIDER_RESISTANCE 1000.0
// #define NTC_RES(adc_val)		(-33000.0 * (3.3 * adc_val / 4095.0)) / ((3.3 * adc_val / 4095.0) - 5)
#define NTC_RES(adc_val)		(5.0*(3.3-v_adc(adc_val))) / (((3.3 * 5.0) / NTC_DIVIDER_RESISTANCE) + 0.00002 - ((5.0/NTC_DIVIDER_RESISTANCE)*(3.3-v_adc(adc_val)))) //NFR26 Rear
